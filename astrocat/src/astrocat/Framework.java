...
public class Framework extends Canvas {
    ...
    //Menu Image
    private BufferedImage astrocatMenuImg;
   ...
   /**
    ...
    private void LoadContent()
    {
    	try
    	{
    		java.net.URL astrocatMenuImgUrl = this.getClass().getResource("/astrocat/resources/images/menu.png");
    		astrocatMenuImg = ImageIO.read(astrocatMenuImgUrl);
    	}
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            break;
            case MAIN_MENU:
            	g2d.drawImage(astrocatMenuImg, 0, 0, frameWidth, frameHeight, null);
            	g2d.drawString("WWW.GAMETUTORIAL.NET", 7, frameHeight - 5);
            	g2d.setColor(Color.white);
            	g2d.drawString("Use -> <- arrows to move the cat.", frameWidth / 2 - 117, frameHeight / 2);
            break;
            case OPTIONS:
                //...
            break;
